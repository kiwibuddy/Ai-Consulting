...
const TOPIC_OPTIONS = [
  {
    id: "ai_church",
    label: "AI & the Church — practical tools and ethical wisdom",
  },
  {
    id: "ai_families",
    label: "AI & Families — raising kids in an AI world",
  },
  {
    id: "fully_human",
    label: "Being Fully Human in an AI Age — identity, purpose, creativity",
  },
  {
    id: "ai_mission",
    label: "AI for Mission — leveraging technology for kingdom impact",
  },
  {
    id: "ai_practical",
    label: "Hands-on AI Workshop — live demos and team exercises",
  },
  {
    id: "custom",
    label: "Custom topic — tell me what you need",
  },
];
...
export default function SpeakingInvitePage() {
  ...
  const submitMutation = useMutation({
    mutationFn: async (data: SpeakingInviteValues) => {
      // Submit to the same intake endpoint with a type flag
      // or a dedicated /api/speaking-invite endpoint
      return apiRequest("POST", "/api/intake", {
        ...data,
        formType: "speaking_invitation",
        // Map fields to existing intake schema where possible
        industry: "speaking_invitation",
        problemStatement: [
          ...
          >
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input
                          placeholder="e.g. Annual Leaders' Retreat 2026"
                          {...field}
                        />
                      </FormControl>
                    </FormItem>
            ...
            <Card className="border-0 shadow-sm bg-white">
              <CardContent className="p-6 md:p-8 space-y-5">
                ...
                <p className="text-sm text-neutral-500 -mt-2">
                  Select any that interest you — I'll tailor the content to your
                  audience. Or suggest your own.
                </p>
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <p className="text-xs text-neutral-400 mt-1">
                        I offer flexible pricing and community rates for smaller
                        churches and volunteer-run organisations. Don't let
                        budget stop you from reaching out.
                      </p>
                    </FormItem>
                  )}
                />
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pt-2">
              <p className="text-xs text-neutral-400 max-w-sm">
                I'll respond within 1–2 business days. If it looks like a good
                fit, we'll arrange a quick call to finalise everything.
              </p>
              <Button
                type="submit"
                size="lg"
