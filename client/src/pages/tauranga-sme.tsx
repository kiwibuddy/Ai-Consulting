        ...
        <section className={`${sectionPadding} bg-[var(--nb-bg)]`}>
          <div className={`container mx-auto ${contentMax}`}>
            ...
            <p className="mt-10 max-w-2xl mx-auto text-center text-xs leading-relaxed text-[var(--nb-ink-soft)]">
              AI disclosure: This pack draws on AI-assisted research — I used Google
              ...
              Claude (Anthropic) supported the editorial process throughout, helping brainstorm,
              edit, and refine the content, and Cursor.ai supported the technical build. Every
              idea, framework, and recommendation was created and confirmed by me — AI assisted
              the research and editing. I take full responsibility for the accuracy and judgement
              in what's delivered here.
            </p>
          </div>
        </section>
      </div>
