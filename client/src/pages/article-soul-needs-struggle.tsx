...
import {
  ...
  articleSummary,
  sourcesList,
} from "@/content/article-soul-needs-struggle";
...
export default function ArticleSoulNeedsStruggle() {
        ...
        <section className="py-12 px-6 border-t border-neutral-200 bg-neutral-50">
          <div className={`${contentMax} mx-auto flex flex-col sm:flex-row items-center justify-between gap-4`}>
            <div className="flex flex-wrap items-center gap-4">
              ...
              <a
                href="https://github.com/kiwibuddy/Ai-Consulting/edit/main/client/src/content/article-soul-needs-struggle.ts"
                target="_blank"
