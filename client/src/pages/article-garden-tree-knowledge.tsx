...
import {
  ...
  sourcesList,
  authorNote,
} from "@/content/article-garden-tree-knowledge";
...
export default function ArticleGardenTreeKnowledge() {
  const [summaryOpen, setSummaryOpen] = useState(false);
  return (
    <div className="nb-page overflow-x-hidden overflow-x-hidden">
      <PageSEO
      ...
      <article className={articleBodyClass}>
        ...
        <section className={`${articleBodyClass} border-b border-neutral-200 px-6 py-5`}>
          <div className={`${articleContentMax} mx-auto flex flex-wrap items-center justify-center gap-3`}>
            <p className="text-sm text-neutral-600">Get a quick one page summary here</p>
            <button
              type="button"
        ...
        <section className={`py-12 px-6 border-t border-neutral-200 ${articleBodyClass}`}>
          <div
            className={`${articleContentMax} mx-auto flex flex-col sm:flex-row items-center justify-between gap-4`}
          >
            <div className="flex flex-wrap items-center gap-4">
              ...
              <a
                href="https://github.com/kiwibuddy/Ai-Consulting/edit/main/client/src/content/article-garden-tree-knowledge.ts"
                target="_blank"
            ...
            <Button asChild>
              <a href="https://www.nathanielbaldock.com/#contact" className="nb-btn-primary">
