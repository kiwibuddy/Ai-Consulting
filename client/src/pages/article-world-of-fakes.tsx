...
import {
  ...
  sourcesList,
  authorNote,
} from "@/content/article-world-of-fakes";
...
export default function ArticleWorldOfFakes() {
        ...
        <section className={`py-12 px-6 border-t border-neutral-200 ${articleBodyClass}`}>
          <div className={`${articleContentMax} mx-auto flex flex-col sm:flex-row items-center justify-between gap-4`}>
            <div className="flex flex-wrap items-center gap-4">
              ...
              <a
                href="https://github.com/kiwibuddy/Ai-Consulting/edit/main/client/src/content/article-world-of-fakes.ts"
                target="_blank"
