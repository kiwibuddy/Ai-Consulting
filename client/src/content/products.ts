...
export const taurangaSmeProducts: Product[] = [
  {
    ...
    promise:
      "In one weekend, you'll have your AI readiness score, a 3-task shortlist, your team conversation done, and your privacy obligations checked - ready for your Regional Business Partner conversation.",
    price: 197,
    currency: "NZD",
    ...
    includes: [
      ...
      "RBP / AI Advisory Pilot conversation cheat-sheet (1-page)",
  ...
  },
  {
    ...
    includes: [
      ...
      "Prep document for the RBPN AI Advisory Pilot (via your local RBP)",
    ],
  },
  {
    ...
    tagline:
      "Eligible for the RBPN AI Advisory Pilot: 50% co-funding, capped at $15,000 NZD.",
    promise:
      "A written 20-page AI Adoption Plan in your business's name - the deliverable the Government's funded pilot is designed to co-fund. Plus 8 weeks of fortnightly check-ins and a 90-min team workshop. At $2,497, approved co-funding is roughly $1,250 (50%) - eligibility confirmed by your RBP growth advisor.",
    price: 2497,
    currency: "NZD",
    ...
    includes: [
      ...
      "Eligible for RBPN co-funding of up to $15,000 NZD",
    ],
  },
];
